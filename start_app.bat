...
start powershell -NoExit -Command "cd project-backend; $env:JAVA_HOME='C:\Program Files\Eclipse Adoptium\jdk-17.0.18.8-hotspot'; .\apache-maven-3.9.9\bin\mvn.cmd spring-boot:run"
